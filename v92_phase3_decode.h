...
typedef struct {
    ...
    int ja_dil_lsp;
    int ja_dil_ltp;
    int ja_dil_unique_train_u;
    int ja_dil_uchords;
    int ja_dil_impairment;
    bool sd_seen;
    int sd_sample;
    int sd_t;
    int sd_reps;
...
typedef struct {
    ...
    int ds_t;
    int ds_reps;
    int sd_wait_after_ja_dil_ms;
    bool sd_wait_within_500ms;
    bool sd_duration_384t_ok;
    bool ds_duration_48t_ok;
    const char *ja_status;
