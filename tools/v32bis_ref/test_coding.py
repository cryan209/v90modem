...
class TxWaveformTests(unittest.TestCase):
    ...
    def test_passband_echo_impairment_adds_delayed_energy(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
        ...
        waveform = symbols_to_baseband(symbols, samples_per_symbol=10, beta=0.5, span_symbols=8)
        passband = baseband_to_passband(waveform, sample_rate=24000, carrier_hz=1800.0)
        impaired = impair_passband_echo(passband, delay_samples=6, gain=0.25)
...
class RxFrontendTests(unittest.TestCase):
    ...
    def test_metadata_free_recovered_stream_drives_logical_receiver_events(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
    ...
    def test_decision_directed_startup_tracking_metadata_free_events(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
    ...
    def test_startup_tracking_survives_mild_combined_channel(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
    ...
    def test_startup_tracking_survives_mild_echo_channel(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
    ...
    def test_startup_tracking_survives_mild_combined_channel_with_echo(self) -> None:
        trace = generate_answer_startup_trace(
            r1_mask=RATE_4800 | RATE_7200 | RATE_9600,
            r2_mask=RATE_4800 | RATE_9600,
            r3_selected_rate=9600,
