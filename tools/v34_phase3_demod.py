...
# ---------------------------------------------------------------------------
# V.34 Table 10 — Mapping parameters K, M and L at different data/symbol rates
# ---------------------------------------------------------------------------
# Each entry: (sym_rate, data_rate) → (K, M_min, M_expanded, L_min, L_expanded)
# K    = shell-mapper bits per mapping frame (§9.2 eq. 9-1)
# M    = number of concentric rings in the 2D constellation (§9.2)
# L    = 2D constellation size; L = 4·M·2^q  (§9.2 eq. 9-2)
# Source: ITU-T V.34 (10/96) Table 10, pp. 15–17.
# ---------------------------------------------------------------------------
V34_TABLE10: dict[tuple[int, int], tuple[int, int, int, int, int]] = {
    # sym   data      K   Mmin Mexp  Lmin  Lexp
    # ----- Symbol rate 2400 -----
    (2400,  2400): ( 0,  1,  1,    4,    4),
    (2400,  2600): ( 0,  1,  1,    4,    4),
    (2400,  4800): ( 4,  2,  2,    8,    8),
    (2400,  5000): ( 5,  2,  2,    8,    8),
    (2400,  7200): (12,  3,  4,   12,   16),
    (2400,  7400): (13,  4,  4,   16,   16),
    (2400,  9600): (20,  6,  7,   24,   28),
    (2400,  9800): (21,  7,  8,   28,   32),
    (2400, 12000): (28, 12, 14,   48,   56),
    (2400, 12200): (29, 13, 15,   52,   60),
    (2400, 14400): (28, 12, 14,   96,  112),
    (2400, 14600): (29, 13, 15,  104,  120),
    (2400, 16800): (28, 12, 14,  192,  224),
    (2400, 17000): (29, 13, 15,  208,  240),
    (2400, 19200): (28, 12, 14,  384,  448),
    (2400, 19400): (29, 13, 15,  416,  480),
    (2400, 21600): (28, 12, 14,  768,  896),
    (2400, 21800): (29, 13, 15,  832,  960),
    # ----- Symbol rate 2743 -----
    (2743,  4800): ( 2,  2,  2,    8,    8),
    (2743,  5000): ( 3,  2,  2,    8,    8),
    (2743,  7200): ( 9,  3,  3,   12,   12),
    (2743,  7400): (10,  3,  3,   12,   12),
    (2743,  9600): (16,  4,  5,   16,   20),
    (2743,  9800): (17,  5,  5,   20,   20),
    (2743, 12000): (23,  8,  9,   32,   36),
    (2743, 12200): (24,  8, 10,   32,   40),
    (2743, 14400): (30, 14, 17,   56,   68),
    (2743, 14600): (31, 15, 18,   60,   72),
    (2743, 16800): (29, 13, 15,  104,  120),
    (2743, 17000): (30, 14, 17,  112,  136),
    (2743, 19200): (28, 12, 14,  192,  224),
    (2743, 19400): (29, 13, 15,  208,  240),
    (2743, 21600): (27, 11, 13,  352,  416),
    (2743, 21800): (28, 12, 14,  384,  448),
    (2743, 24000): (26, 10, 12,  640,  768),
    (2743, 24200): (27, 11, 13,  704,  832),
    (2743, 26400): (25,  9, 11, 1152, 1408),
    (2743, 26600): (26, 10, 12, 1280, 1536),
    # ----- Symbol rate 2800 -----
    (2800,  4800): ( 2,  2,  2,    8,    8),
    (2800,  5000): ( 3,  2,  2,    8,    8),
    (2800,  7200): ( 9,  3,  3,   12,   12),
    (2800,  7400): (10,  3,  3,   12,   12),
    (2800,  9600): (16,  4,  5,   16,   20),
    (2800,  9800): (16,  4,  5,   16,   20),
    (2800, 12000): (23,  8,  9,   32,   36),
    (2800, 12200): (23,  8,  9,   32,   36),
    (2800, 14400): (30, 14, 17,   56,   68),
    (2800, 14600): (30, 14, 17,   56,   68),
    (2800, 16800): (28, 12, 14,   96,  112),
    (2800, 17000): (29, 13, 15,  104,  120),
    (2800, 19200): (27, 11, 13,  176,  208),
    (2800, 19400): (28, 12, 14,  192,  224),
    (2800, 21600): (26, 10, 12,  320,  384),
    (2800, 21800): (27, 11, 13,  352,  416),
    (2800, 24000): (25,  9, 11,  576,  704),
    (2800, 24200): (26, 10, 12,  640,  768),
    (2800, 26400): (24,  8, 10, 1024, 1280),
    (2800, 26600): (24,  8, 10, 1024, 1280),
    # ----- Symbol rate 3000 -----
    (3000,  4800): ( 1,  2,  2,    8,    8),
    (3000,  5000): ( 2,  2,  2,    8,    8),
    (3000,  7200): ( 8,  2,  3,    8,   12),
    (3000,  7400): ( 8,  2,  3,    8,   12),
    (3000,  9600): (14,  4,  4,   16,   16),
    (3000,  9800): (15,  4,  5,   16,   20),
    (3000, 12000): (20,  6,  7,   24,   28),
    (3000, 12200): (21,  7,  8,   28,   32),
    (3000, 14400): (27, 11, 13,   44,   52),
    (3000, 14600): (27, 11, 13,   44,   52),
    (3000, 16800): (25,  9, 11,   72,   88),
    (3000, 17000): (26, 10, 12,   80,   96),
    (3000, 19200): (24,  8, 10,  128,  160),
    (3000, 19400): (24,  8, 10,  128,  160),
    (3000, 21600): (30, 14, 17,  224,  272),
    (3000, 21800): (31, 15, 18,  240,  288),
    (3000, 24000): (28, 12, 14,  384,  448),
    (3000, 24200): (29, 13, 15,  416,  480),
    (3000, 26400): (27, 11, 13,  704,  832),
    (3000, 26600): (27, 11, 13,  704,  832),
    (3000, 28800): (25,  9, 11, 1152, 1408),
    (3000, 29000): (26, 10, 12, 1280, 1536),
    # ----- Symbol rate 3200 -----
    (3200,  4800): ( 0,  1,  1,    4,    4),
    (3200,  5000): ( 1,  2,  2,    8,    8),
    (3200,  7200): ( 6,  2,  2,    8,    8),
    (3200,  7400): ( 7,  2,  2,    8,    8),
    (3200,  9600): (12,  3,  4,   12,   16),
    (3200,  9800): (13,  4,  4,   16,   16),
    (3200, 12000): (18,  5,  6,   20,   24),
    (3200, 12200): (19,  6,  6,   24,   24),
    (3200, 14400): (24,  8, 10,   32,   40),
    (3200, 14600): (25,  9, 11,   36,   44),
    (3200, 16800): (30, 14, 17,   56,   68),
    (3200, 17000): (31, 15, 18,   60,   72),
    (3200, 19200): (28, 12, 14,   96,  112),
    (3200, 19400): (29, 13, 15,  104,  120),
    (3200, 21600): (26, 10, 12,  160,  192),
    (3200, 21800): (27, 11, 13,  176,  208),
    (3200, 24000): (24,  8, 10,  256,  320),
    (3200, 24200): (25,  9, 11,  288,  352),
    (3200, 26400): (30, 14, 17,  448,  544),
    (3200, 26600): (31, 15, 18,  480,  576),
    (3200, 28800): (28, 12, 14,  768,  896),
    (3200, 29000): (29, 13, 15,  832,  960),
    (3200, 31200): (26, 10, 12, 1280, 1536),
    (3200, 31400): (27, 11, 13, 1408, 1664),
    # ----- Symbol rate 3429 -----
    (3429,  4800): ( 0,  1,  1,    4,    4),
    (3429,  5000): ( 0,  1,  1,    4,    4),
    (3429,  7200): ( 5,  2,  2,    8,    8),
    (3429,  7400): ( 6,  2,  2,    8,    8),
    (3429,  9600): (11,  3,  3,   12,   12),
    (3429,  9800): (11,  3,  3,   12,   12),
    (3429, 12000): (16,  4,  5,   16,   20),
    (3429, 12200): (17,  5,  5,   20,   20),
    (3429, 14400): (22,  7,  8,   28,   32),
    (3429, 14600): (23,  8,  9,   32,   36),
    (3429, 16800): (28, 12, 14,   48,   56),
    (3429, 17000): (28, 12, 14,   48,   56),
    (3429, 19200): (25,  9, 11,   72,   88),
    (3429, 19400): (26, 10, 12,   80,   96),
    (3429, 21600): (31, 15, 18,  120,  144),
    (3429, 21800): (31, 15, 18,  120,  144),
    (3429, 24000): (28, 12, 14,  192,  224),
    (3429, 24200): (29, 13, 15,  208,  240),
    (3429, 26400): (26, 10, 12,  320,  384),
    (3429, 26600): (27, 11, 13,  352,  416),
    (3429, 28800): (24,  8, 10,  512,  640),
    (3429, 29000): (24,  8, 10,  512,  640),
    (3429, 31200): (29, 13, 15,  832,  960),
    (3429, 31400): (30, 14, 17,  896, 1088),
    (3429, 33600): (27, 11, 13, 1408, 1664),
    (3429, 33800): (27, 11, 13, 1408, 1664),
}


def v34_mapping_params(sym_rate: int, data_rate: int,
                       expanded: bool = False) -> tuple[int, int, int]:
    """Look up (K, M, L) from V.34 Table 10.

    Args:
        sym_rate:   symbol rate in baud (2400/2743/2800/3000/3200/3429)
        data_rate:  data rate in bit/s (must be a Table 10 entry)
        expanded:   if True return the expanded (shaping) M and L values;
                    if False (default) return the minimum values

    Returns:
        (K, M, L) tuple as defined in §9.2.

    Raises:
        KeyError if the (sym_rate, data_rate) pair is not in Table 10.
    """
    K, M_min, M_exp, L_min, L_exp = V34_TABLE10[(sym_rate, data_rate)]
    if expanded:
        return K, M_exp, L_exp
    return K, M_min, L_min
