...
typedef enum {
    ...
    VPCM_V90_MODEM_PHASE2,
    VPCM_V90_MODEM_PHASE3,
    VPCM_V90_MODEM_PHASE4,
    VPCM_V90_MODEM_DATA,
...
typedef struct {
    ...
    bool phase2_caller_saw_info1;
    bool phase2_caller_phase3_tx_ready;
    int phase2_u_info;
    int phase2_caller_tx_stage;
    int phase2_caller_rx_stage;
    int phase2_answerer_tx_stage;
    int phase2_answerer_rx_stage;
    ...
    bool phase3_native_analogue_started;
    bool phase3_native_analogue_completed;
    int phase3_native_caller_tx_stage;
    int phase3_native_caller_rx_stage;
    int phase3_native_caller_rx_event;
    int phase3_native_caller_j_bits;
    int phase3_native_caller_j_trn16;
    int phase3_native_caller_trn_lock_score;
    int phase3_native_answerer_tx_stage;
    int phase3_native_answerer_rx_stage;
    int phase3_native_answerer_rx_event;
    int phase3_native_answerer_j_bits;
    int phase3_native_answerer_j_trn16;
    int phase3_native_answerer_trn_lock_score;
    bool phase4_native_analogue_started;
    bool phase4_native_analogue_completed;
    bool phase4_native_caller_tx_data_mode;
    bool phase4_native_answerer_tx_data_mode;
    int phase4_native_caller_tx_stage;
    int phase4_native_caller_rx_stage;
    int phase4_native_caller_rx_event;
